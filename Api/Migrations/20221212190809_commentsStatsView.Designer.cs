...
namespace Api.Migrations
{
    ...
    [Migration("20221212190809_commentsStatsView")]
    partial class commentsStatsView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.BlackListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DAL.Entities.CommentStats", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToView("CommentsStats", (string)null);
                });
            ...
            modelBuilder.Entity("DAL.Entities.MuteListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DAL.Entities.PostStats", b =>
                {
                    ...
                    b.Property<long>("CommentsAmount")
                        .HasColumnType("bigint");
                    ...
                    b.ToView("PostsStats", (string)null);
                });
            ...
            modelBuilder.Entity("DAL.Entities.UserActivity", b =>
                {
                    ...
                    b.Property<long>("FollowingAmount")
                        .HasColumnType("bigint");

                    b.Property<long>("PostsAmount")
                        .HasColumnType("bigint");
                    ...
                    b.ToView("UsersActivity", (string)null);
                });

            modelBuilder.Entity("DAL.Entities.UserConfig", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DAL.Entities.BlackListItem", b =>
                {
                    b.HasOne("DAL.Entities.User", "BlockedUser")
            ...
            modelBuilder.Entity("DAL.Entities.MuteListItem", b =>
                {
                    b.HasOne("DAL.Entities.User", "MutedUser")
            ...
            modelBuilder.Entity("DAL.Entities.UserConfig", b =>
                {
                    b.HasOne("DAL.Entities.User", "User")
                        .WithOne("Config")
                        .HasForeignKey("DAL.Entities.UserConfig", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
